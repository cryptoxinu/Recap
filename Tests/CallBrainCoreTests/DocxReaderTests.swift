...
struct DocxReaderTests {
    ...
    func extractTextCore() {
        ...
        <w:p><w:r><w:t>Riley said Render </w:t></w:r><w:r><w:t>spot pricing dropped &amp; stabilized.</w:t></w:r></w:p>
        <w:p><w:r><w:t xml:space="preserve">✍️ Quick Notes</w:t></w:r></w:p>
        <w:p><w:r><w:t>• [Alex] Ship the importer</w:t></w:r></w:p>
        <w:p></w:p>
        """
        ...
        #expect(lines.contains("Riley said Render spot pricing dropped & stabilized.")) // runs joined + &amp; unescaped
        #expect(!out.contains("✍️"))                                                // pen-emoji line dropped
        #expect(lines.contains("• [Alex] Ship the importer"))                       // bullet stays, NOT a heading

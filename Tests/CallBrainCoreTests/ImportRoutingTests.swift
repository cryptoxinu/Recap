...
struct ImportRoutingTests {
    ...
    func detectsGemini() {
        ...
        Alex implemented Discord scrapers.
        ## Revenue and billing
    ...
    func fathomDocxNotGemini() {
        // DocxReader prefixes bold short lines with `## `; a colon-less Fathom header `Riley 0:00`
        // becomes `## Riley 0:00`. Must still be seen as a transcript, not shredded as notes.
        let t = """
        ## Section one
        ## Riley 0:00

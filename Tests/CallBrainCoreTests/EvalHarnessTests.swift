...
struct EvalHarnessTests {
    ...
    private func seedCorpus(_ store: Store, embedder: any Embedder, space: String) async throws {
        let meetings: [(String, String, [(String, String, String)])] = [
            ("m_render", "2026-06-29", [("c_render", "Riley", "On Render, the GPU spot pricing dropped sharply this week, lowering inference cost.")]),
            ("m_val", "2025-02-10", [("c_val", "Dom", "Validators stake to secure the network; emissions drive the economics.")]),
        ]
    ...
    func liveGrounding() async throws {
        ...
        let cases = [
            EvalCase(id: "render-answer", question: "What did Riley say about Render?",

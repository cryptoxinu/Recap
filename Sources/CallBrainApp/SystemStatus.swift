...
/// Probes the live state of CallBrain's engines — the premium CLIs (`claude` / `codex`) and the local
...
final class SystemStatus {
    ...
    /// means "the binary CallBrain will actually run is present + executable", not a generic PATH guess.

...
public enum VectorMath {
    ...
    /// Exact brute-force top-k by cosine. Returns up to `k` `ScoredID`, best-first.
    public static func topK(query: [Float], candidates: [(id: String, vector: [Float])], k: Int) -> [ScoredID] {
